...
$query4 = "SELECT * from store where SID='$user_check'";
 ...
 if(isset($_POST['submitn']))
  ...
  {$updtname = ($_POST['inputcs']);
    $updatequery1 = "UPDATE store set SCOUNTRY='$updtname' where SID='$para1'";mysqli_query($conn, $updatequery1);
    header("Refresh:0");}
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <h1 class="mb-5" style="font-size:40px">"Store Login- CIT Mart"</h1>
  ...
  <br>
   ...
   <tr>
    ...
    <td><input type="submit" name="submitc"></td>
      ...
      <tr>
    <td>Branch State:</td>
    <td><input type="text" name="inputs" placeholder="<?php echo "$para4"?>"></td>
    <td><input type="submit" name="submits"></td>
   </tr>
      <tr>
    <td>Branch Country:</td>
    <td><input type="text" name="inputcs" placeholder="<?php echo "$para5"?>"></td>
    <td><input type="submit" name="submitcs"></td>
   </tr>
      <tr>
    <td>PINCODE:</td>
